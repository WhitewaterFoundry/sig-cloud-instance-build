...
# Repositories to use
repo --name="SL" --baseurl=http://ftp.scientificlinux.org/linux/scientific/6x/x86_64/os/ --cost=100
repo --name="SL Updates" --baseurl=http://ftp.scientificlinux.org/linux/scientific/6x/x86_64/updates/ --cost=100
